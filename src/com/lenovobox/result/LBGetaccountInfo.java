...
public class LBGetaccountInfo {
	...
	private String X-LENOVO-SESS-ID;
	private Object AT;
	...
	public String getXLENOVOSESSID() {
              if (X-LENOVO-SESS-ID==null) {
                  return "";
              }
              else{
                  return X-LENOVO-SESS-ID;
              }
	}

	public void setXLENOVOSESSID(String X-LENOVO-SESS-ID) {
		this.X-LENOVO-SESS-ID = X-LENOVO-SESS-ID;
	}
